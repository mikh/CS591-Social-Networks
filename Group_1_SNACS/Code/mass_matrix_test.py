		...
		for file in input_files:
			if 'reddit' in file and 'g' in file and 'n' in file and 'cro' in file and 'con' in file:
				if not file in output_files:
					if not 'n1000' in file and not 'n1500' in file and not 'n2000' in file:
						...
						locked = True
						command = '"py\\Scripts\\python algorithm_runner.py --set_name={file} --set_matlab_path="{matlab_path}""'.format(file=file, matlab_path="E:\\Programs\\Matlab2016\\bin\\matlab.exe")
						os.system(command)
